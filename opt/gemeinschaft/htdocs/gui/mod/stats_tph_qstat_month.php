...
while ($r = $rs->fetchrow()) {
	...
	echo '<td style="background-color:'.$bgcolor.';">', $queue_name ,'</td>', "\n";
	echo '<td style="background-color:'.$bgcolor.';">', $ddisplay ,'.', $mdisplay ,'.', $y ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $num_count_entered,'</td>', "\n";
	echo '<td style="background-color:'.$bgcolor.';">',  $num_abandoned_lt  ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">',  $num_abandoned_gt  ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">',  $num_connected_gt ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">',  $num_connected_lt ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">',  round($calls_in_svl_percent , 0) ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $sum_calldur ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $count_waittime ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $sum_review ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $avg_calldur ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', round($avg_waittime) ,'</td>', "\n";  
	...
	echo '<td style="background-color:'.$bgcolor.';">', $avg_review ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $count_calldur_lt ,'</td>', "\n";
	...
	echo '<td style="background-color:'.$bgcolor.';">', $count_calldur_gt ,'</td>', "\n";
...
echo '<a href="', GS_URL_PATH, 'srv/csv-tph-month-export.php?month='.$m.'&year='.$y.'&num_days='.$num_days.'" title="', __('CSV Export b '), '">'.__('CSV Export').'</a>';
?>
